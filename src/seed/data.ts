...
export const seedWallets = [
  ...
  },
  {
    ...
    userId: seedUser.id,
    name: 'Visa Falabella',
    balance: cents(1770000),
    type: 'TARJETA_CREDITO',
    color: '#8b5cf6',
    includeInTotal: false,
    isActive: true,
    creditLimit: cents(2500000),
    availableCredit: cents(730000),
...
export const seedInstallmentOccurrences = [
  {
    id: 'installment_laptop_1',
    installmentPlanId: 'installment_laptop',
    userId: seedUser.id,
    installmentNumber: 1,
    dueAt: new Date('2026-03-05T08:00:00-05:00'),
    expectedAmount: cents(400000),
    status: 'EJECUTADA',
  },
  {
    id: 'installment_laptop_2',
    installmentPlanId: 'installment_laptop',
    userId: seedUser.id,
    installmentNumber: 2,
  ...
  },
  {
    ...
    userId: seedUser.id,
    installmentNumber: 3,
    dueAt: new Date('2026-05-05T08:00:00-05:00'),
    expectedAmount: cents(400000),
    status: 'PENDIENTE',
  },
]
...
export const seedTransactions = [
  ...
  },
  {
    ...
    status: 'REGISTRADA',
    title: 'Portátil Asus',
    description: 'Compra a cuotas importada',
    categoryId: 'cat_finanzas',
    amount: cents(-2400000),
    installmentPlanId: 'installment_laptop',
    occurredAt: new Date('2026-02-02T14:30:15-05:00'),
    recordedAt: new Date('2026-05-04T09:00:00-05:00'),
    isVisible: true,
  },
  {
    id: 'tx_cc_charge',
