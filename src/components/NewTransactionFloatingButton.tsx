...
export const NewTransactionFloatingButton = ({ walletId }: NewTransactionFloatingButtonProps) => {
    ...
    return (
        <Button
            asChild
            className='fixed bottom-6 right-6 hidden rounded-full p-0 shadow-lg transition-all duration-300 hover:shadow-xl md:flex md:h-16 md:w-16 bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white'
        >
            <Link href={href}>
